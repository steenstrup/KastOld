...
namespace Kast.Models.Dnd5E
{
    ...
    public class SpellBuilder
    {
        ...
        public SpellBuilder LoadCantrip()
        {
            ...
            _spell.Add(new Spell() { Name = "Fire Bolt", Level = 0, Damage = "2d10", DamageType = "Fire", Range = "120 feet" });
        ...
        {
            _spell.Add(new Spell() { Name = "Chromatic Orb", Level = 1, Damage = "3d8", DamageType = "Pick", Range = "90 feet" });
            ...
            _spell.Add(new Spell() { Name = "Guiding Bold", Level = 1, Damage = "4d6", DamageType = "Radiant", Range= "120 feet" });
        ...
        public SpellBuilder LoadLvl2Spell()
        {
            ...
            _spell.Add(new Spell() { Name = "Mirre Image", Level = 2});
